 ...
 */
class PaperworkSearch extends Paperwork
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['nama_program', 'pw_obj', 'pw_background', 'pw_advantage', 'pw_startdate','pw_endDate', 'jangka_masa', 'pw_submit_status','pw_dateUpdated'], 'safe'],
            [['pw_budget'], 'number'],
        ];
    }
